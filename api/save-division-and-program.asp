...
Set Results = Server.CreateObject("Scripting.Dictionary")
    ...
    Dim sqll : sqll = "EXEC [spSaveDivisionAndProgram] @accessToken='" & accessToken & "', @name='" & ob("name") & "', @id='" & cleanGuid(ob("id")) & "', @statusId='" & ob("statusId") & "', @facultyId='" & cleanGuid(ob("facultyId")) & "' "
